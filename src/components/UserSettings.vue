  ...
  <div class="UserSettings">
    <div class="mainContainer">
      ...
      <div class="editAvatarImgContainer" v-if="typeof state.getAvatar != 'undefined'">
        <img :src="state.userAvatar" class="editAvatarImg">
      </div>
...
export default{
  ...
  methods:{
    ...
    updateAvatar(){
      let sendData = {userName: this.state.loggedinUserName, passhash: this.state.passhash, newAvatar: this.state.userAvatar}
